  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="h-32 bg-background rounded-md flex items-center justify-center text-muted-foreground">
          <p className="text-sm">
            GitHub contribution graph would appear here
            <br />
            <span className="text-xs">
              (Integrate with GitHub API or use a service like GitHub Readme Stats)
            </span>
          </p>
        </div>
      </motion.div>
